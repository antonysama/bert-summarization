...
tf.app.flags.DEFINE_integer('max_enc_steps', 8, 'max timesteps of encoder (max source text tokens)')
tf.app.flags.DEFINE_integer('max_dec_steps', 4, 'max timesteps of decoder (max summary tokens)')
